            ...
            >
              <div className="stack gap-6">
                ...
                <p className="lede" style={{ maxWidth: 460, marginTop: 12 }}>
                  Not a thing you bought. A morning. A long walk. The whole of next Sunday. Write it
                  down, send it across, and mean it.
                </p>
                <div className="row gap-3 mt-4">
                  <Link href="/create" className="btn btn-lg">
                    Write a gift <Icon name="arrow-right" size={15} />
                  </Link>
                ...
                <div className="row gap-6 mt-6 muted" style={{ fontSize: 13, flexWrap: 'wrap' }}>
                  ...
                  <span className="row gap-2" style={{ whiteSpace: 'nowrap' }}>
                    <Icon name="mail" size={14} /> Works without an account
                  </span>
                </div>
              </div>
        ...
        >
          <div className="container">
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 2fr', gap: 64, alignItems: 'start' }}>
              ...
              <div
                className="serif"
                style={{ fontSize: 28, lineHeight: 1.35, color: 'var(--ink-soft)', maxWidth: 720 }}
              >
                We&apos;ve made gifts about <em>things.</em> Boxes, wrap, the right shade of something.
                But the people who love you mostly want one thing —{' '}
                <span style={{ color: 'var(--ink)' }}>a piece of the week you didn&apos;t give to anyone else.</span>{' '}
                Timegift is a way to actually send that.
              </div>
            </div>
          </div>
        </section>
          ...
          <div className="container">
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 32 }}>
              <Step
                ...
                body="Pick who, how much time, and what for. Or leave it open. The form reads like a letter, because it is one."
              />
              <Step
                n="02"
                title="Send it across"
                body="By email, text, or WhatsApp. They don't need an account. They open a card with your handwriting in it."
              />
              <Step
                n="03"
                title="Find the day"
                body="They pick a time that works. You both get the invite. Then the only thing left is to show up."
              />
            </div>
          </div>
        </section>
        ...
        <section className="section center">
          <div className="container">
            <h2 className="serif" style={{ fontSize: 56, letterSpacing: '-0.02em', marginBottom: 16 }}>
              ...
              <em>with three hours of someone?</em>
            </h2>
            ...
            <div className="row gap-3 mt-8" style={{ justifyContent: 'center' }}>
              <Link href="/create" className="btn btn-lg">
                Write your first gift <Icon name="arrow-right" size={15} />
              </Link>
            </div>
          </div>
        </section>
...
function Step({ n, title, body }: { n: string; title: string; body: string }) {
  return (
    <div className="stack gap-3">
      <div
        className="serif"
        style={{ fontSize: 52, color: 'var(--accent)', lineHeight: 1, letterSpacing: '-0.02em' }}
      >
        {n}
      </div>
      ...
      <p className="muted" style={{ fontSize: 14.5, maxWidth: 320, lineHeight: 1.55 }}>
        {body}
      </p>
    </div>
  );
...
function Feature({ title, body }: { title: string; body: string }) {
  return (
    <div style={{ background: 'var(--paper)', padding: '32px 28px' }}>
      <h4 className="serif" style={{ fontSize: 19, marginBottom: 8 }}>
        {title}
      </h4>
...
function ExampleLetter() {
  return (
    <div className="card-letter" style={{ maxWidth: 460 }}>
      <Stamp amount={3} unit="hours" year={2026} />
      ...
      <p className="handwritten" style={{ marginBottom: 14 }}>
        I&apos;ve been meaning to say this for months. You&apos;re the reason I picked up writing again. Three
        hours — coffee, a long walk, or just sitting on the porch. Pick the day.
      </p>
